...
DATASET_PATH = "benchmarks/safeguard_prompt_injection.json"
RESULTS_PATH = "benchmarks/safeguard_results_full.json"
...
print(f"Source: xTRam1/safe-guard-prompt-injection (train+test)")
...
print()
print("=== Benchmark: xTRam1/safe-guard-prompt-injection ===")
print(f"Dataset: {len(samples)} samples ({injection_count} injection, {benign_count} benign)")
print()
