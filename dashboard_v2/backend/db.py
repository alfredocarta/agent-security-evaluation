...
BLOCK_OUTCOMES = {"BLOCKED", "KILL_SWITCH", "OUTPUT_BLOCK", "L1.5_BLOCK"}
...
ARTICLE_OUTCOMES: dict[str, Any] = {
    "Art. 9": {"KILL_SWITCH", "BLOCKED", "L1.5_BLOCK"},
    "Art. 10": _BENCHMARK_EVENTS,
    "Art. 12": _ALL_OUTCOMES,   # entire audit trail is Art. 12 evidence
    "Art. 13": {"ALLOWED", "BLOCKED", "KILL_SWITCH", "OUTPUT_BLOCK", "L1.5_BLOCK"},
